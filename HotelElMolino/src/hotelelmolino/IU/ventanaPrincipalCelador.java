...
public class ventanaPrincipalCelador extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ventanaPrincipalCelador
     */
    public ventanaPrincipalCelador() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaPrincipalCelador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaPrincipalCelador().setVisible(true);
            }
        });
    }
