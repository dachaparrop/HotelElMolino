...
public class ventanaInventarioC extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sugerenciaI.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hotelelmolino/IMAGENES/inventario.png"))); // NOI18N
        ...
        jLabel6.setText("COSTO PRODUCTO/S");

        jLabel7.setText("CANTIDAD POR HABITACION");

        jLabel8.setText("CANTIDAD EN HOTEL");

        jLabel9.setText("ID AMINISTRADOR");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        if(ventanalogin.getTabla().equals("inventario")){
            try {
                ...
                funcion.setBigDecimal(3, new BigDecimal(thirdText.getText()));
                funcion.setInt(4, Integer.parseInt(fourthText.getText()));
                funcion.setInt(5, Integer.parseInt(fifthText.getText()));
                funcion.setInt(6, Integer.parseInt(sixthText.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaInventarioC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaInventarioC().setVisible(true);
            }
        });
    }
