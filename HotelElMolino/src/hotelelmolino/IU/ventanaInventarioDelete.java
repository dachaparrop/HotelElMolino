...
public class ventanaInventarioDelete extends javax.swing.JFrame {
     ...
     */
    public ventanaInventarioDelete() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaInventarioDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaInventarioDelete().setVisible(true);
            }
        });
    }
