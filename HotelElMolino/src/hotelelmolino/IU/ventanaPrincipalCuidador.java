 ...
 * @author angie
 */
public class ventanaPrincipalCuidador extends javax.swing.JFrame {

    ventanaLogin ventanalogin = new ventanaLogin();

    /**
     * Creates new form ventanaPrincipalCuidador
     */
    public ventanaPrincipalCuidador() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaPrincipalCuidador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaPrincipalCuidador().setVisible(true);
            }
        });
    }
